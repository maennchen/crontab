defmodule Crontab.FunctionalTest do
  ...
  tests_find_date = [
    ...
    { "0 0 LW * *",         "0 0 LW * * *",       ~N[2016-12-24 00:00:00],  ~N[2016-12-30 00:00:00], :none,                     false         }, # Should be found, maxes out
    { "0 0 2W * *",         "0 0 2W * * *",       ~N[2011-07-01 00:00:00],  ~N[2011-07-01 00:00:00], ~N[2011-07-01 00:00:00],   true          },
    { "0 0 1W * *",         "0 0 1W * * *",       ~N[2011-05-01 00:00:00],  ~N[2011-05-02 00:00:00], :none,                     false         }, # Should be found, maxes out
    { "0 0 1W * *",         "0 0 1W * * *",       ~N[2011-07-01 00:00:00],  ~N[2011-07-01 00:00:00], ~N[2011-07-01 00:00:00],   true          },
    { "0 0 3W * *",         "0 0 3W * * *",       ~N[2011-07-01 00:00:00],  ~N[2011-07-04 00:00:00], :none,                     false         }, # Should be found, maxes out
    { "0 0 16W * *",        "0 0 16W * * *",      ~N[2011-07-01 00:00:00],  ~N[2011-07-15 00:00:00], :none,                     false         }, # Should be found, maxes out
  ...
  tests_find_date_extended = [
    ...
    { "*/2 */2 * * * *",    "*/2 */2 * * * * *",  ~N[2015-08-10 21:47:27],  ~N[2015-08-10 21:48:00],  ~N[2015-08-10 21:46:58],  false         },
